...
assembler.recipeBuilder().duration(600).EUt(30).inputs([<gregtech:meta_item_1:12184>*4,<minecraft:redstone>*8,<minecraft:tripwire_hook>,<minecraft:gunpowder>*24,<gregtech:meta_item_1:16184>*32]).notConsumable(<gregtech:meta_item_1:32766>.withTag({Configuration: 24})).outputs([<mw:m67frag>]).buildAndRegister();
assembler.recipeBuilder().duration(600).EUt(30).inputs([<gregtech:meta_item_1:12184>*4,<minecraft:redstone>*8,<minecraft:tripwire_hook>,<gregtech:meta_item_1:2156>*2,<gregtech:meta_item_1:2038>*16]).notConsumable(<gregtech:meta_item_1:32766>.withTag({Configuration: 25})).outputs([<mw:flash>]).buildAndRegister();
assembler.recipeBuilder().duration(600).EUt(30).inputs([<gregtech:meta_item_1:12184>*4,<minecraft:redstone>*8,<minecraft:tripwire_hook>,<gregtech:meta_item_1:2156>*2,<gregtech:meta_item_1:2054>*16]).notConsumable(<gregtech:meta_item_1:32766>.withTag({Configuration: 26})).outputs([<mw:flash>]).buildAndRegister();
assembler.recipeBuilder().duration(600).EUt(30).inputs([<gregtech:meta_item_1:12184>*4,<minecraft:gunpowder>*8,<gregtech:meta_item_1:2156>*2,<gregtech:meta_item_1:2038>*8]).notConsumable(<gregtech:meta_item_1:32766>.withTag({Configuration: 27})).outputs([<mw:impactgrenade>]).buildAndRegister();
assembler.recipeBuilder().duration(600).EUt(30).inputs([<gregtech:meta_item_1:12184>*4,<minecraft:gunpowder>*8,<gregtech:meta_item_1:2156>*2,<gregtech:meta_item_1:2054>*8]).notConsumable(<gregtech:meta_item_1:32766>.withTag({Configuration: 28})).outputs([<mw:impactgrenade>]).buildAndRegister();
assembler.recipeBuilder().duration(600).EUt(30).inputs([<gregtech:meta_item_1:12184>*4,<minecraft:redstone>*8,<minecraft:tripwire_hook>,<gregtech:meta_item_1:2050>*32,<gregtech:meta_item_1:2156>*2]).notConsumable(<gregtech:meta_item_1:32766>.withTag({Configuration: 29})).outputs([<mw:m18white>]).buildAndRegister();
assembler.recipeBuilder().duration(600).EUt(30).inputs([<gregtech:meta_item_1:12184>*4,<minecraft:glass_pane>*4,<minecraft:redstone>*8,<ore:circuitBasic>,<gregtech:meta_item_1:32690>]).notConsumable(<gregtech:meta_item_1:32766>.withTag({Configuration: 30})).outputs([<mw:tablet>]).buildAndRegister();
assembler.recipeBuilder().duration(600).EUt(30).inputs([<gregtech:meta_item_1:12184>*4,<minecraft:glass_pane>*4,<minecraft:redstone>*8,<ore:circuitBasic>,<gregtech:meta_item_1:32680>]).notConsumable(<gregtech:meta_item_1:32766>.withTag({Configuration: 31})).outputs([<mw:wcam>]).buildAndRegister();
assembler.recipeBuilder().duration(600).EUt(30).inputs([<gregtech:meta_item_1:12184>*4,<minecraft:glass_pane>*4,<minecraft:redstone>*8,<ore:circuitBasic>,<gregtech:meta_item_1:32680>,<gregtech:meta_item_1:32690>]).notConsumable(<gregtech:meta_item_1:32766>.withTag({Configuration: 32})).outputs([<mw:gas-detector>]).buildAndRegister();
fluid_canner.recipeBuilder().duration(600).EUt(30).inputs([<mw:m67frag>]).fluidInputs([<liquid:chlorine>*1000]).outputs([<mw:gasgrenade>]).buildAndRegister();
assembler.recipeBuilder().duration(600).EUt(120).inputs([<minecraft:glass_pane>*2,<gregtech:meta_item_1:12144>*12,<gregtech:meta_item_1:2012>*8]).notConsumable(<gregtech:meta_item_1:32766>.withTag({Configuration: 32})).outputs(<mw:m40gasmask_helmet>).buildAndRegister();
